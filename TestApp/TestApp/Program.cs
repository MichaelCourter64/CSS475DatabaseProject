...
namespace TestApp
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            SqlConnection sqlConnection = new SqlConnection("user id=mAsterAcc;" +
                                       "password=fescdwax;server=css475mariadbbasedgamelibrary.cuk3vrnaztl4.us-west-2.rds.amazonaws.com;" +
